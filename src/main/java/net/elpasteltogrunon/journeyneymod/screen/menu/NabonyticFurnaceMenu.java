...
public class NabonyticFurnaceMenu extends AbstractContainerMenu
{
    public static NabonyticFurnaceBlockEntity blockEntity;
    ...
    {
        super(ModMenuTypes.NABONYTIC_FURNACE_MENU.get(), id);
        checkContainerSize(inv, 4);
        blockEntity = (NabonyticFurnaceBlockEntity) entity;
